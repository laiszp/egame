...
<body onload="verificarBadge(${imagemBadge})">
					...
					<form class="form-horizontal bucket-form" method="get">
						...
						<h2>OBRIGADO!</h2>
							<label class="control-label" style="text-align: justify">Olá ${userWeb.nome}! 
									<br>
									Muito obrigado pela sua contribuição nesse experimento. Qualquer dúvida ou detalhes por favor contate o seu professor ou os pesquisadores.
							 </label><p></p>
						</div>          
						<br></br>
